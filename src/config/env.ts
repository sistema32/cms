...
const envSchema = z.object({
  ...
  REQUEST_MAX_JSON_BYTES: z.string().transform(Number).default("1000000"),
  REQUEST_MAX_JSON_DEPTH: z.string().transform(Number).default("30"),
  REQUEST_AUTH_MAX_JSON_BYTES: z.string().transform(Number).default("250000"),
  REQUEST_AUTH_MAX_JSON_DEPTH: z.string().transform(Number).default("10"),
  REQUEST_MEDIA_MAX_BYTES: z.string().transform(Number).default("8000000"),
  REQUEST_MEDIA_MAX_JSON_DEPTH: z.string().transform(Number).default("20"),
  // Email configuration
...
export const env = envSchema.parse({
  ...
  REQUEST_MAX_JSON_BYTES: Deno.env.get("REQUEST_MAX_JSON_BYTES"),
  REQUEST_MAX_JSON_DEPTH: Deno.env.get("REQUEST_MAX_JSON_DEPTH"),
  REQUEST_AUTH_MAX_JSON_BYTES: Deno.env.get("REQUEST_AUTH_MAX_JSON_BYTES"),
  REQUEST_AUTH_MAX_JSON_DEPTH: Deno.env.get("REQUEST_AUTH_MAX_JSON_DEPTH"),
  REQUEST_MEDIA_MAX_BYTES: Deno.env.get("REQUEST_MEDIA_MAX_BYTES"),
  REQUEST_MEDIA_MAX_JSON_DEPTH: Deno.env.get("REQUEST_MEDIA_MAX_JSON_DEPTH"),
  // Email
