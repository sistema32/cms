  ...
  const editorModalHtml = `
    <div id="imageEditorModal" class="modal-backdrop fixed inset-0 z-[60] flex items-center justify-center">
      <div class="modal-container max-w-7xl w-full max-h-[95vh] overflow-hidden">
        ...
        <div class="flex flex-col lg:flex-row gap-4 h-[calc(95vh-8rem)]">
          <div class="flex-[3] bg-gray-900 rounded-lg overflow-hidden flex items-center justify-center relative">
          ...
          <div class="flex-[1] bg-gray-50 dark:bg-gray-800 p-4 rounded-lg overflow-y-auto space-y-4">
            <div class="space-y-3">
