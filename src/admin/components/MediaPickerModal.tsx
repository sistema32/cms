      ...
      <div style="max-width: 1200px; margin: 0 auto; background: white; border-radius: 0.75rem; padding: 1.5rem; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25);">
        ...
        <div style="display: flex; gap: 1rem; margin-bottom: 1.5rem;">
            <div style="display: flex; gap: 0.5rem; background: #f3f4f6; padding: 0.25rem; border-radius: 0.5rem;">
                <button type="button" class="media-tab active" onclick="switchMediaTab('library')" style="padding: 0.5rem 1rem; border-radius: 0.25rem; border: none; font-size: 0.875rem; font-weight: 600; cursor: pointer; background: white; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">Biblioteca</button>
                <button type="button" class="media-tab" onclick="switchMediaTab('upload')" style="padding: 0.5rem 1rem; border-radius: 0.25rem; border: none; font-size: 0.875rem; font-weight: 600; cursor: pointer; background: transparent; color: #666;">Subir Archivos</button>
            </div>
        ...
        <div id="mediaPickerContent" style="min-height: 400px; max-height: 60vh; overflow-y: auto;">
            ...
            <div id="mediaUploadView" style="display: none; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center; border: 2px dashed #e5e7eb; border-radius: 0.75rem; padding: 4rem; text-align: center;">
                ...
                <button 
                    type="button" 
                    onclick="document.getElementById('globalMediaUploadInput').click()"
        ...
        <div style="margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid #eef0f2; display: flex; justify-content: flex-end; gap: 0.75rem;">
            <button type="button" onclick="closeMediaPicker()" style="padding: 0.625rem 1.25rem; border-radius: 0.375rem; border: 1px solid #e5e7eb; background: white; font-weight: 500; cursor: pointer;">Cancelar</button>
            <button type="button" id="mediaSelectBtn" disabled onclick="confirmMediaSelection()" style="padding: 0.625rem 1.25rem; border-radius: 0.375rem; border: none; background: #e5e7eb; color: #9ca3af; font-weight: 600; cursor: not-allowed; transition: all 0.2s;">Seleccionar</button>
        </div>
