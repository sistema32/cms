...
export const PluginsMarketplaceNexusPage = (
  props: PluginsMarketplaceNexusPageProps,
) => {
  const {
    user,
    plugins,
  ...
  const content = html`
    ...
    <div class="page-header-nexus">
            ...
            >
              <div class="plugin-header">
                <div style="flex: 1;">
                  ...
                  <p class="plugin-meta">v${plugin.version} • ${plugin
                    .author}</p>
                  ${NexusBadge({
              ...
              <div class="plugin-rating-row">
                ...
                <span style="opacity: 0.6;">${formatNumber(
                  plugin.downloads,
                )} descargas</span>
              </div>
        ...
        ${NexusCard({
          children: html`
            <div style="text-align: center; padding: 3rem 2rem;">
              ...
              <p style="font-size: 0.9375rem; opacity: 0.6;">
      ...
      async function downloadPlugin(pluginName, price) {
        ...
        // TODO: Implementar descarga desde marketplace
        alert('Esta funcionalidad aún no está implementada. Por favor, descarga el plugin manualmente.');
      }
