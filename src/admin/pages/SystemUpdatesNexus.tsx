  ...
  const content = html`
      ...
      <div class="version-info">
        ...
        ${lastChecked ? html`
          <div class="version-item">
            ...
            <span style="font-size: 0.875rem; color: var(--nexus-base-content, #1e2328); opacity: 0.7;">
    ...
    <div class="tab-content active" data-content="updates">
      ${updates.length === 0 ? html`
        <div class="empty-state">
          ...
          <h3 style="margin-top: 1rem; font-size: 1.125rem; font-weight: 600;">Sistema Actualizado</h3>
          <p style="margin-top: 0.5rem; font-size: 0.875rem;">No hay actualizaciones disponibles en este momento</p>
        </div>
      ` : html`
            ...
            <div class="update-item" data-update-id="${update.id}">
              ...
              ${update.cveIds && update.cveIds.length > 0 ? html`
                <div class="update-badges">
                  <span style="font-size: 0.8125rem; font-weight: 600; margin-right: 0.5rem;">CVEs:</span>
              ...
              ${update.requiresBackup || update.requiresRestart ? html`
                <div style="display: flex; gap: 1rem; font-size: 0.8125rem; color: var(--nexus-base-content, #1e2328); opacity: 0.6; margin-bottom: 1rem;">
    ...
    <div class="tab-content" data-content="news">
      ${news.length === 0 ? html`
        <div class="empty-state">
          ...
          <h3 style="margin-top: 1rem; font-size: 1.125rem; font-weight: 600;">No hay noticias</h3>
          <p style="margin-top: 0.5rem; font-size: 0.875rem;">No hay noticias disponibles en este momento</p>
        </div>
      ` : html`
        <div class="news-grid">
          ${news.map(item => html`
    ...
    <div class="tab-content" data-content="config">
      ${NexusCard({
        ...
        children: html`
          <p style="font-size: 0.875rem; color: var(--nexus-base-content, #1e2328); opacity: 0.7; margin-bottom: 1.5rem;">
            Configura cómo y cuándo se deben verificar e instalar las actualizaciones del sistema
          </p>
          <div style="display: flex; flex-direction: column; gap: 1rem;">
            <label style="display: flex; align-items: center; gap: 0.75rem; cursor: pointer;">
              <input type="checkbox" ${config?.enabled ? 'checked' : ''} style="width: 18px; height: 18px;" />
              <span style="font-size: 0.875rem; font-weight: 500;">Habilitar sistema de actualizaciones</span>
            </label>
            <label style="display: flex; align-items: center; gap: 0.75rem; cursor: pointer;">
              <input type="checkbox" ${config?.autoDownload ? 'checked' : ''} style="width: 18px; height: 18px;" />
              <span style="font-size: 0.875rem; font-weight: 500;">Descargar actualizaciones automáticamente</span>
            </label>
            <label style="display: flex; align-items: center; gap: 0.75rem; cursor: pointer;">
              <input type="checkbox" ${config?.autoInstall ? 'checked' : ''} style="width: 18px; height: 18px;" />
              <span style="font-size: 0.875rem; font-weight: 500;">Instalar actualizaciones automáticamente</span>
            </label>
            <label style="display: flex; align-items: center; gap: 0.75rem; cursor: pointer;">
              <input type="checkbox" ${config?.notifyOnUpdate ? 'checked' : ''} style="width: 18px; height: 18px;" />
              <span style="font-size: 0.875rem; font-weight: 500;">Notificar sobre actualizaciones</span>
            </label>
            <label style="display: flex; align-items: center; gap: 0.75rem; cursor: pointer;">
              <input type="checkbox" ${config?.autoBackupBeforeUpdate ? 'checked' : ''} style="width: 18px; height: 18px;" />
              <span style="font-size: 0.875rem; font-weight: 500;">Respaldar automáticamente antes de actualizar</span>
            </label>
          </div>
          <div style="margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid var(--nexus-base-200, #eef0f2); display: flex; justify-content: flex-end; gap: 0.75rem;">
            ${NexusButton({
              label: "Restablecer",
              type: "outline"
            })}
