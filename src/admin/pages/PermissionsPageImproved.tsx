...
export const PermissionsPageImproved = (props: PermissionsPageProps) => {
  const { user, permissions, permissionsByModule, modules, stats } = props;
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="flex gap-2">
                        <button
                          class="btn-edit-permission text-purple-600 hover:text-purple-800 dark:text-purple-400"
                          title="Editar"
                          data-id="${perm.id}"
                        ...
                        <button
                          class="btn-delete-permission text-red-600 hover:text-red-800 dark:text-red-400"
                          title="Eliminar"
                          data-id="${perm.id}"
