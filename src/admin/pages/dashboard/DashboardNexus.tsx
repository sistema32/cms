...
export const DashboardNexusPage = (props: DashboardNexusProps) => {
  ...
  const content = html`
    ...
    <div class="quick-actions">
      <a href="${env.ADMIN_PATH}/posts/new" class="quick-action-btn">
      ...
      <a href="${env.ADMIN_PATH}/pages/new" class="quick-action-btn">
        <div class="quick-action-icon">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="${env.ADMIN_PATH}/media" class="quick-action-btn">
        <div class="quick-action-icon">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  <a href="${env.ADMIN_PATH}/users/new" class="quick-action-btn">
    <div class="quick-action-icon">
      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="lg:col-span-2">
      <div class="content-card">
        <div class="content-card-header">
          ...
          <a href="${env.ADMIN_PATH}/activity" class="content-card-action">Ver todo →</a>
        </div>
