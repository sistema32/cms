...
export const pluginHealth = mysqlTable("plugin_health", {
    id: serial("id").primaryKey(),
    pluginId: integer("plugin_id").notNull().references(() => plugins.id, { onDelete: "cascade" }),
...
export const pluginPermissionGrants = mysqlTable("plugin_permission_grants", {
    id: serial("id").primaryKey(),
    pluginId: integer("plugin_id").notNull().references(() => plugins.id, { onDelete: "cascade" }),
...
// ============= CONTENT_SEO =============
export const contentSeo = mysqlTable("content_seo", {
    id: serial("id").primaryKey(),
    contentId: integer("content_id").notNull().references(() => content.id, {
        onDelete: "cascade",
    }).unique(),
...
// ============= CONTENT_META =============
export const contentMeta = mysqlTable("content_meta", {
    id: serial("id").primaryKey(),
    contentId: integer("content_id").notNull().references(() => content.id, {
        onDelete: "cascade",
    }),
...
// ============= CONTENT_FILTERS =============
export const contentFilters = mysqlTable("content_filters", {
    id: serial("id").primaryKey(),
...
// ============= MEDIA_SIZES =============
export const mediaSizes = mysqlTable("media_sizes", {
    id: serial("id").primaryKey(),
...
// ============= MEDIA_SEO =============
export const mediaSeo = mysqlTable("media_seo", {
    id: serial("id").primaryKey(),
    mediaId: integer("media_id").notNull().references(() => media.id, {
        onDelete: "cascade",
    }).unique(),
...
// ============= CATEGORY_SEO =============
export const categorySeo = mysqlTable("category_seo", {
    id: serial("id").primaryKey(),
    categoryId: integer("category_id").notNull().references(() => categories.id, {
        onDelete: "cascade",
    }).unique(),
...
// ============= WIDGET AREAS =============
export const widgetAreas = mysqlTable("widget_areas", {
    id: serial("id").primaryKey(),
    slug: text("slug").notNull().unique(),
    name: text("name").notNull(),
    description: text("description"),
...
// Plugins relations defined above with migrations/health
...
// IP Block Rules
export const ipBlockRules = mysqlTable("ip_block_rules", {
    id: serial("id").primaryKey(),
